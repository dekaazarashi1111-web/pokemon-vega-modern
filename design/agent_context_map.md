...
| 現在遊ぶROM、Codex対戦、アイテム送付、バグ修正 | `design/active_play_baseline.md`, `config/active_play_baseline.json` | `docs/CODEX_BATTLE_OPERATOR_JA.md`, `docs/WINDOWS_BATTLE_CATALOG_JA.md`, `docs/WINDOWS_BOX14_VAULT_JA.md`, `docs/IPAD_RETROARCH_MGBA_SAVE_PLACEMENT.md` |
| Stage61固定スナップショットのポケモン・技・特性・アイテム入手質問 | `docs/wiki/stage61/CODEX_INDEX.md` | `docs/wiki/stage61/data/search_index.jsonl`, 対象entityのMarkdown、`docs/wiki/stage61/RUNTIME_LIMITATIONS.md` |
