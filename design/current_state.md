...
- USER-20260824-STAGE51-WORLD-RUNTIME-E2E-REPAIR: IN_PROGRESS（`PASS_LOCAL_IPAD_ROM_SAVE_PLACED_AWAITING_PLAY`）。Stage53の全owner監査、18 fresh-core fixture×2 process、BPS、declared span外0、allocator overlap 0、iPad別名ROM／正常save配置はPASS。ユーザー実プレイ確認までDONEにしない。
