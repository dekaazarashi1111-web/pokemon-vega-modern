...
- P01はDONE。P02〜P08は未完了で、release readyではない。累積開発候補はStage69 `build/stages/69_modernization_floette_gift.gba`、SHA-256 `6532002dabd3197ee6b8ded8b153a495d3241acf062fc931210987093172cb95`、CRC32 `4849DD0F`。現行プレイ基準Stage62へは昇格していない。
...
- Mega 49件とStone 45件のprivate-use素材は再現可能にstaging済み。ただしMega用Species固定表、base+石の49対応、戦闘中変化・解除、新Ability 6件のROM hookは後続Stage70以降で進行中のためP04は未完了。Browt／Pombon／GecquaはID・素材・runtimeを予約しない`NON_ADOPTED_USER_SCOPE`のまま。
