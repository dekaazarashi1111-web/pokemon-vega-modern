...
- USER-20260824-STAGE51-WORLD-RUNTIME-E2E-REPAIR: IN_PROGRESS（`PASS_LOCAL_AWAITING_IPAD`）。Stage53の全owner監査、18 fresh-core fixture×2 process、BPS、declared span外0、allocator overlap 0はPASS。ユーザー実プレイ確認までDONEにしない。
