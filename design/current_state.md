...
- P01はDONE。P02〜P08は未完了で、release readyではない。P08の選択済み累積候補はStage74 `build/stages/74_modernization_p03_supply_runtime.gba`、SHA-256 `481083bc50bd353955990375e3cc5e0a76f9b0f681ae54caa6c31f66ef22d65e`、CRC32 `C9929F79`へ更新した。現行プレイ基準Stage62へは昇格していない。
