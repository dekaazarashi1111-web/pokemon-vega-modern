...
- P01はDONE。P02〜P08は未完了で、release readyではない。P08の選択済み累積候補はStage76 `build/stages/76_modernization_p05_edges.gba`、SHA-256 `f753f13720aeb5331cfc8a9bf9dd5fd4ad9ac34537356d20d76b73e0100100ac`、CRC32 `0A78B46A`へ更新した。現行プレイ基準Stage62へは昇格していない。
