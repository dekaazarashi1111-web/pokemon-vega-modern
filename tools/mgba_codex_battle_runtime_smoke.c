...
enum {
    ...
    CBR_TRAINER_PARTY_SITE = 0x09096EC4U,
    CBR_SAVE_LOAD_SITE = 0x080DB4E4U,
    CBR_RECEPTION_POINTER = 0x093C2DC0U,
    ...
    CBR_DYNAMAX_BAND_EXECUTION_SITE = 0x090F1494U,
    CBR_GIGANTAMAX_BAND_EXECUTION_SITE = 0x090F14C8U,
    CBR_DYNAMAX_BAND_UI_SITE = 0x090F1688U,
