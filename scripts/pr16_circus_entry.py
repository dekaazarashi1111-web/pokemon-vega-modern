...
def compile_adapter(folder, address, owners):
    from pr16_circus_thumb import compile_adapter as compile_thumb
    return compile_thumb(ROOT, folder, address, owners)
...
def run():
    ...
    sources=(SELF,SOURCE,'scripts/pr16_circus_thumb.py','tests/test_pr16_circus_thumb.py','tests/test_pr16_circus_entry.py','tests/test_pr16_circus_entry_binding.py','.github/workflows/pr16-circus-entry.yml')
