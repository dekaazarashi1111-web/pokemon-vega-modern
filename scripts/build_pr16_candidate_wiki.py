...
def generate(inputs: Inputs) -> tuple[dict[str, bytes], dict]:
    ...
    from pr16_candidate_wiki_saved_link import enrich as enrich_saved_link, append_pages as append_saved_link
    ...
    enrich_saved_link(model, inputs, raw)
