"""第2戦中断: CRC64・実1勝・破棄→復旧・保存後3coreを原本から検証。"""
import json
import struct
import zlib
...
def analyze(events,r):
    ...
    for e in events:
        ...
        need(e['save_counter']==(3 if e['label'] in ('saved','reloaded') else 2),'unexpected standard Save')
    ...
    return dict(classification='CIRCUS_SECOND_BATTLE_INTERRUPTION_RECOVERY_SAVE_CONTINUE',
        ...
        normal_saves=1,fresh_cores=3,owner_bytes_verified=64,party_bytes_verified=600,
