...
EXPECTED_STAGE34_SHA256 = "84395df49b5cee3fa83b501714828fa03db29bc24b1ed0f1a9cb292e1437946f"
...
HOOKS = {
    ...
    "build_trainer_party": (0x090DD198, "TrainerV5Runtime_BuildTrainerPartySetup"),
}
...
CONFIGURE_NEXT_BATTLE_POLICY_ADDRESS = 0x091260A9
CFRU_PENDING_CLEAR_ADDRESS = 0x0910ED2D
BATTLE_POLICY_ADDRESSES = {
    "CAN_MEGA": 0x09126A15,
    "MARK_MEGA": 0x09126A41,
    "CAN_Z": 0x09126A69,
    "MARK_Z": 0x09126A95,
    "CAN_DYNAMAX": 0x09126ABD,
    "MARK_DYNAMAX": 0x09126AE9,
    "CAN_TERA": 0x09126B11,
    "MARK_TERA": 0x09126B3D,
    "BEGIN": 0x091265A9,
    "END": 0x09126815,
}
...
LOAD_PROPER_ABILITY_BATTLE_DATA_ADDRESS = 0x090BB351
...
def _discover_authoring_registry(root: Path) -> Path:
    ...
    for candidate in candidates:
        if (candidate / "nature_ids.csv").is_file():
            return candidate
    _fail("authoring registry directory cannot be discovered")
...
def _discover_task06(root: Path) -> Path:
    ...
    for candidate in candidates:
        if (candidate / "KIT_MANIFEST.json").is_file():
            return candidate
    _fail("Task06 directory cannot be discovered")
