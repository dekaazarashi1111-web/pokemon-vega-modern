...
状態 `PARTIAL_NATURAL_SUPPLY`、source `e98e3a2581419a721e3e3ad7b0f351ba84371119`、run `36102544792`。Actions終端 `False`。
...
保存成功 `['caterpie-initial-hatch', 'leepun-initial-hatch']`。未成功 `['floette-eternal-npc-initial']`。今回unit 20、host compile 2、native process 3。終端記録専用の場合これらの再実行0。
