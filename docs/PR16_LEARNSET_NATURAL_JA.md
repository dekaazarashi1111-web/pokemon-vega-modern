...
状態 `FAIL` / run36041199782 / source `47ee15b2ab3d45d94b0b50b0553294f79799157d`。
...
新unit0、native1、成功0、fresh core1。
受入済みアメ11/Bag23/旧戦闘/egg8/旧host/ARM/Wikiの再実行0。
成功しても実観測owner/この空き枠ケースのみ。全owner・配布・孵化・form・EXP共有・置換・拒否・進化へ拡張しない。
Actions終端確認 `False`。原本 `content/modernization/pr16_learnset_natural_evidence/36041199782`。
