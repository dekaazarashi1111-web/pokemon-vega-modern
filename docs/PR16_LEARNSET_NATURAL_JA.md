...
状態 `FAIL` / run36040704821 / source `51242ac859b3a27402d7567cc347c785ac5e8174`。
...
新unit0、native1、成功0、fresh core0。
受入済みアメ11/Bag23/旧戦闘/egg8/旧host/ARM/Wikiの再実行0。
成功しても実観測owner/この空き枠ケースのみ。全owner・配布・孵化・form・EXP共有・置換・拒否・進化へ拡張しない。
Actions終端確認 `False`。原本 `content/modernization/pr16_learnset_natural_evidence/36040704821`。
