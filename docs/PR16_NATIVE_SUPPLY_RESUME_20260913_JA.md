...
getter限定修復の実証と停止原本を記録。受入済み30勝/BPは不変。未観測を成功へ昇格しない。[{'stage': 'getter-native-or-build', 'type': 'ValueError', 'error': 'BL range'}]
...
証拠のsource HEAD: `5c112d62e1be8f884f9bb7402d7d605fdfa20cec`。
