...
候補 `6e88a021785bfa7cf00e26d7f2433c380602d830e94e1d2fc31e3198cda31df2`、run35852603289 / source `94a1b43c81b4de1d9773d9ea3a4457e59534d570`。状態 `FAIL`。
...
新unit 0 / 継承unit 31、新native 1、今回成功fresh core 0、累計成功8ケース。失敗原本と成功原本を保持し成功caseの単純再実行禁止。正本 `content/modernization/pr16_learnset_progression_checkpoint.json`。Actions終端は後続の記録限定照合で確定。
