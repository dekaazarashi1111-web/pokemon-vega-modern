...
状態 `PARTIAL_BATTLE_EXP_EVOLUTION_SHARE`。入力HEAD `d951b8cc7600c5412b9db7c30172e57cf0cb454e`、run `36079930352`。Actions終端確認 `False`。
...
新unit 6、host compile 1、新native 1。保存成功 ['metapod-exp-cancel', 'metapod-exp-evolve']。未成功 ['butterfree-exp-share']。原本 `content/modernization/pr16_exp_evolution_share_evidence/36079930352`。
