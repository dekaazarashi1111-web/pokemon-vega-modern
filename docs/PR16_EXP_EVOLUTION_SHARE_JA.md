...
状態 `PARTIAL_BATTLE_EXP_EVOLUTION_SHARE`。入力HEAD `97417f139591689085d88a866fd638e7dc6fae87`、run `36076513362`。Actions終端確認 `False`。
...
新unit 12、host compile 1、新native 3。保存成功 []。未成功 ['metapod-exp-evolve', 'metapod-exp-cancel', 'butterfree-exp-share']。原本 `content/modernization/pr16_exp_evolution_share_evidence/36076513362`。
