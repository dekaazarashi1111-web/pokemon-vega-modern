...
状態 `PARTIAL_BATTLE_EXP_EVOLUTION_SHARE`。入力HEAD `6b69b8d48644d255962d218dcce81ff01c4904a7`、run `36075652959`。Actions終端確認 `False`。
...
新unit 24、host compile 1、新native 3。保存成功 []。未成功 ['metapod-exp-evolve', 'metapod-exp-cancel', 'butterfree-exp-share']。原本 `content/modernization/pr16_exp_evolution_share_evidence/36075652959`。
