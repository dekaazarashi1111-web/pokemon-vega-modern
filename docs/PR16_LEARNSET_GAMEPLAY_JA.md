...
候補 `6e88a021785bfa7cf00e26d7f2433c380602d830e94e1d2fc31e3198cda31df2` / CRC32 `00F31AF7`。run35831256129、source `059826fec559df3c543dd20cc549b470418ad5dd`。

状態 `PASS_SCOPED`、新規native 23 process、成功23/23ケース。初期場所・party・進行・道具はfixtureであり、通常ストーリーからの取得の証拠ではない。通常操作中は7host書込APIを禁止する3区間で観測。
