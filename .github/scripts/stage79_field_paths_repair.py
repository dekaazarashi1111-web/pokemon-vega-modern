...
PREIMAGES = {
    ...
    '.github/workflows/modernization-stage79-mgba.yml': 'e48bdfc946df489293b9e5c77abc506ed6c6719e0c3fecd060348e44b3eab87f',
}
NEW_FILES = {
...
def main() -> None:
    ...
    targets = sorted(set(PREIMAGES) | NEW_FILES | {
        repair.OUTPUT_PATH, repair.REPORT_PATH,
