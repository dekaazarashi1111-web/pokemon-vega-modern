...
github-battle-wrapper-test:
	$(PYTHON) -m unittest tests.test_run_github_battle_command tests.test_github_private_environment tests.test_github_comment_control tests.test_github_large_file_bridge tests.test_run_github_private_suite
