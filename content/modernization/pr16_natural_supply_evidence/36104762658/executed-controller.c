...
#define B_SCOPE "ISSUE19_NATURAL_INITIAL_HATCH_SAVE_CONTINUE"
...
#define B_ROM_SHA "b7790902733a638445129c388d65ab3c199bceb92a41338e0069221b556b9f91"
...
static const struct BCase b_cases[] = {
    {"caterpie-initial-hatch", {33,0,0,0}, {33,0,0,0},0,0,{33,81,0,0},649,649,15},
    {"leepun-initial-hatch", {10,0,0,0}, {10,0,0,0},0,0,{10,39,0,0},1,1,20},
};
struct BTrace {
...
int main(int argc,char **argv) {
    ...
    clear_parties(c);b_create(c,QOL_PLAYER_PARTY,v->mother_species,0x123456F0U,0x11223344U);
