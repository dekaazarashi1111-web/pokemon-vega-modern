...
New events default to `SIMPLE_EVENT`: reuse an existing NPC or terminal, a short standard dialogue, one condition/flag update, and an existing reward/battle/warp command. Avoid new event UI, custom cutscenes, minigames, and decorative assets unless an acceptance gate cannot be met without them.
