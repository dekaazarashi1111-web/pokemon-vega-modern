...
#include "../windows_box14_vault/windows_box14_vault.h"
#endif
...
#endif
#if CODEX_WINDOWS_BOX14_VAULT_ENABLED
    CODEX_VAULT_COMMAND_SCAN = WINDOWS_BOX14_VAULT_COMMAND_SCAN,
    CODEX_VAULT_COMMAND_EXPORT = WINDOWS_BOX14_VAULT_COMMAND_EXPORT,
    CODEX_VAULT_COMMAND_REMOVE = WINDOWS_BOX14_VAULT_COMMAND_REMOVE,
    CODEX_VAULT_COMMAND_IMPORT = WINDOWS_BOX14_VAULT_COMMAND_IMPORT,
#endif
};
...
#if CODEX_WINDOWS_BOX14_VAULT_ENABLED
    CODEX_REWARD_ERROR_VAULT_CHANGED = 25,
    CODEX_REWARD_ERROR_VAULT_EMPTY = 26,
    CODEX_REWARD_ERROR_VAULT_ABI = 27,
    CODEX_REWARD_ERROR_VAULT_SLOT_OCCUPIED = 28,
    CODEX_REWARD_ERROR_VAULT_MAIL = 29,
#endif
};
