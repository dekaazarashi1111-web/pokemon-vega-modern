...
#define FN_MOVE_RELEARN_POOL PTR(MovePoolFn, 0x09114089u)
#define FN_TRY_SAVING_DATA PTR(TrySavingDataFn, 0x080DB34Du)
#define FN_SAVE_FINALIZE PTR(SaveFinalizeFn, 0x092D2605u)
#define FN_SAVE_VALIDATE PTR(SaveValidateFn, 0x092D10D1u)
#define FN_SAVE_INIT PTR(SaveInitFn, 0x092D2649u)
#define FN_STAGE35_SAVE_LOAD PTR(TrySavingDataFn, 0x093031DDu)
#define FN_STAGE35_CONFIGURE_TRAINER \
    PTR(ConfigureTrainerBattleFn, 0x09302865u)
#define FN_STAGE35_TRAINER_BATTLE_END PTR(TrainerBattleEndFn, 0x09302F81u)
#define FN_CONFIGURE_HIGH_RAID PTR(ConfigureRaidFn, 0x091261E1u)
#define FN_CFRU_PENDING_CLEAR PTR(VoidFn, 0x0910ED2Du)
#define FN_CFRU_IS_RAID PTR(ContextFlagFn, 0x0912625Du)
...
#define FN_ORIGINAL_BATTLE_ACTION PTR(VoidFn, 0x09118B6Du)
#define FN_ORIGINAL_BATTLE_MOVE PTR(VoidFn, 0x09116E41u)
...
#define FN_CHECK_MOVE_LIMITATIONS PTR(MoveLimitFn, 0x090D4D89u)
#define FN_IS_MON_SHINY PTR(IsMonShinyFn, 0x08043AB9u)
#define FN_DAYCARE_GIVE_EGG PTR(DaycareFn, 0x090EAB0Du)
#define FN_DAYCARE_TRIGGER_PENDING PTR(DaycareFn, 0x090EB3F1u)
#define FN_DAYCARE_COMPATIBILITY PTR(DaycareScoreFn, 0x090EB6D5u)
#define FN_SUBTRACT_EGG_STEPS PTR(SubtractEggStepsFn, 0x090EB621u)
#define FN_SHOULD_EGG_HATCH PTR(ShouldEggHatchFn, 0x0804594Du)
#define FN_TRY_DECREMENT_EGG_STEPS PTR(TryDecrementEggFn, 0x090EB651u)
#define FN_MODIFY_BREEDING_SCORE PTR(ModifyBreedingScoreFn, 0x090EB7EDu)
#define FN_REUSABLE_TM PTR(ReusableTmFn, 0x0911079Du)
...
#define FN_APPLY_EXP_CANDY PTR(ApplyExpCandyFn, 0x09131EC9u)
#define FN_APPLY_EV_RESET_ITEM PTR(ApplyEvResetItemFn, 0x091321D9u)
#define FN_APPLY_EV_RESET_ALL PTR(ApplyEvResetAllFn, 0x09132391u)
#define FN_HYPER_TRAINING PTR(HyperTrainingFn, 0x09128CC5u)
#define FN_CALCULATE_MON_STATS PTR(CalculateMonStatsFn, 0x090D93A9u)
#define FN_WILD_GENERATE PTR(WildGenerateFn, 0x09220065u)
#define FN_FISHING_GENERATE PTR(FishingGenerateFn, 0x092200FDu)
#define FN_STANDARD_WILD_BATTLE PTR(VoidFn, 0x091332CDu)
...
#define FN_GET_ALL_EGG_MOVES PTR(GetAllEggMovesFn, 0x090EB821u)
...
#define FN_ORIGINAL_MON_TRY_LEARNING PTR(MonTryLearningMoveFn, 0x09113EEDu)
...
#define FN_GET_SPECIES_EXP PTR(GetSpeciesExpFn, 0x090FC3B9u)
#define FN_CANDY_VALUE PTR(CandyValueFn, 0x09131E89u)
#define FN_EFFECTIVE_LEVEL_CAP PTR(EffectiveLevelCapFn, 0x09131EC5u)
#define FN_GET_EVOLUTION_TARGET PTR(EvolutionTargetFn, 0x090FB629u)
